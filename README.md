...
Current development release: **0.7.4**
...
native-writer profiling, and version 0.7.4 makes expensive writer benchmarks
bounded and observable on dense BigWig signals.
...
- **0.7.4**: bounded writer benchmarking, interval-density guards, and progress diagnostics — current stage.
- **0.7.5**: conditional native writer optimization if the bounded benchmark justifies it.
